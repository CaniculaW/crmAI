...
- UAT 准出材料：RC/UAT readiness、启动治理 validator、UAT 启动输入 validator、UAT 证据包生成器、UAT 证据包 Go/No-Go validator、UAT 缺陷台账 validator、UAT 证据清单 validator、UAT 签署台账 validator、验收清单一致性检查、生成文档一致性检查和计划状态一致性检查测试
