...
| RC/UAT就绪审计 | 已形成 | `scripts/v1-uat-readiness-check.mjs` 检查候选版本记录、自动化验证报告、验收清单、追踪矩阵、Runbook、UAT证据模板、Compose部署入口和CI质量门齐备性；配套 `scripts/v1-uat-readiness-check.test.mjs` |
