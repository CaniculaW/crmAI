...
| `node --test scripts/*.test.mjs` | 283 tests passed |
...
| `node --test scripts/v1-external-uat-request.test.mjs` | 3 tests passed；覆盖 No-Go 外部 UAT 请求包、机器可读最终门禁命令、绝对路径 UAT 源文档和全量 Go 状态 |
