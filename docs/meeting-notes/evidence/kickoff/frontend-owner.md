# CRM V1 Kickoff Governance Evidence - 前端负责人
...
Update target row: `docs/meeting-notes/crm-kickoff-minutes.md` 参会人/前端负责人
...
1. Replace every pending value with concrete evidence for `前端负责人`.
