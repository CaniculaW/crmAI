# CRM V1 Kickoff Governance Evidence - 业务验收人-销售侧
...
Update target row: `docs/meeting-notes/crm-kickoff-minutes.md` 参会人/业务验收人-销售侧
...
1. Replace every pending value with concrete evidence for `业务验收人-销售侧`.
