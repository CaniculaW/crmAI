# CRM V1 Kickoff Governance Evidence - 测试负责人
...
Update target row: `docs/meeting-notes/crm-kickoff-minutes.md` 参会人/测试负责人
...
1. Replace every pending value with concrete evidence for `测试负责人`.
